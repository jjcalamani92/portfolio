...
export function HeaderP0(props: Props) {
    ...
    <div className="">
      <header className=" inset-x-0 top-0 z-50">
            ...
            <Link href="/" className="text-2xl font-medium">
              ...
              {/* {
                logo?.type === 'html'
                  ...
                  <h1>Logo</h1>
                  :
                  <img src={logo?.content} alt='logo description' />
              } */}
            </Link>
          </div>
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed top-0 right-0 shadow-lg rounded-lg m-2 z-50 w-3/4 overflow-y-auto h-auto px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 bg-cris-fill ">
