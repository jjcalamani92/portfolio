  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
        <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="https://humanidades.com/wp-content/uploads/2018/09/astronauta-e1537822973762.jpg" />
        <div className="text-center lg:w-2/3 w-full">
          ...
          <div className="flex justify-center">
            <button className="inline-flex text-white bg-cris-accent border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
